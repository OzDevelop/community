...
public class RedisConfig {
     ...
     */
    @Bean
    public RedisTemplate<String, UserPostQueueItem> redisTemplate() {
        RedisTemplate<String, UserPostQueueItem> redisTemplate = new RedisTemplate<>();
     ...
     */
    @Bean
    public ListOperations<String, UserPostQueueItem> listOperations(RedisTemplate<String, UserPostQueueItem> redisTemplate) {
     ...
     */
    @Bean
    public ValueOperations<String, UserPostQueueItem> valueOperations(RedisTemplate<String, UserPostQueueItem> redisTemplate) {
